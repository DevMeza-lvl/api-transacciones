...
return [
    ...
    'try_it_out' => [
        ...
        'base_url' => env('SCRIBE_TRY_BASE_URL', config('app.url')),
    ...
    'extra_info' => 'Pega aquí tu token (sin "Bearer ").',
],
    ...
    'strategies' => [
    // Información general del endpoint (grupo, título, descripción, método, etc.)
        'metadata' => [
